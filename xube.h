...
// Creating a pattern where each cell has a distinct color to easily identify orientation
// This is a simplified representation of corners and orientation:
//
// Colors in RGB565 format:
// c0 = dark blue  (0x001F)
// c1 = bright red (0xF800)
// c2 = mix 2/3 c0 + 1/3 c1 = purple-blue
// c3 = mix 1/3 c0 + 2/3 c1 = reddish-purple
//
// We'll create a pattern that looks like:
// c0 c1 c1 c1  (dark blue corner, then red)
// c1 c2 c2 c1  (red edge, middle gradient, red edge)
// c1 c2 c2 c1  (red edge, middle gradient, red edge)
// c1 c1 c1 c3  (red edge, then reddish-purple corner)
//
// This makes the orientation very clear by the position of the dark blue and reddish corners

constexpr BYTE bc1_texture_data[] = {
    // Color0: Black (R[15:11], G[10:5], B[4:0]) big endian
    0x00, 0x00,
    // Color1: White
    0xFF, 0xFF,
    // Indices for 4x4 block in row-major order (0=c0, 1=c1, 2=c2, 3=c3)
    // need a pattern that clearly shows orientation and borders when tiled
...
constexpr UINT texturedata[] = // 4x4 pixel checkerboard pattern, 0xAARRGGBB
{
...
// Updated vertex data with more meaningful UV coordinates to map to the 4x4 texture
